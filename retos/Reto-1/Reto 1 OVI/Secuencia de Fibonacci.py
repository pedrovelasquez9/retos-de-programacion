...
print('Su valor introducido tiene la siguiente secuencia iterativa de 20 números:')
...
print('Su valor introducido tiene la siguiente secuencia recursiva de 20 números:')
def fib_r(n):
    if n < 2:
        return n
